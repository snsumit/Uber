...
const VehiclePanel = ({ setImage,setVehicleType,fare,setConfirmRidePanel,setVehiclePanelOpen}) => {
    ...
    <div>
         <h4 onClick={() => {
          ...
          <div onClick={()=>{
                 ...
                 setVehicleType('car')
                 setImage('https://www.pngplay.com/wp-content/uploads/8/Uber-PNG-Photos.png')
